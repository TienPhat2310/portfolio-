    ...
    <section id="about" className="py-24">
      <div className="flex flex-col lg:flex-row gap-12 w-full items-center">
        ...
        <div className="flex-1">
          <p className="font-[family-name:var(--font-mono)] px-4 py-1.5 rounded-full border border-border bg-surface/50 text-accent text-sm tracking-widest w-fit mb-6">
            ABOUT ME
          </p>
          ...
          <div className="space-y-6 text-muted text-base md:text-lg leading-relaxed bg-surface/30 backdrop-blur-sm border border-white/5 rounded-2xl p-8">
            <p>
        ...
        <div className="flex-1 w-full max-w-md lg:max-w-none">
          <div className="rounded-2xl border border-white/10 bg-surface/40 backdrop-blur-xl overflow-hidden shadow-[0_0_40px_rgba(57,255,136,0.05)] hover:shadow-[0_0_40px_rgba(57,255,136,0.1)] hover:-translate-y-2 transition-all duration-500 relative group">
            ...
            <div className="p-8 font-[family-name:var(--font-mono)] text-sm space-y-6 relative z-10">
              ...
              <div className="flex items-center mt-4">
                <span className="text-accent mr-2">❯</span><span className="w-2.5 h-5 bg-accent animate-pulse block shadow-[0_0_10px_rgba(57,255,136,0.6)]"></span>
              </div>
            </div>
