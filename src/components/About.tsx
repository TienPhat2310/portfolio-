    ...
    <section id="about" className="py-24">
      <div className="flex flex-col lg:flex-row gap-12 w-full items-center">
        ...
        <div className="flex-1">
          <p className="font-[family-name:var(--font-mono)] px-4 py-1.5 rounded-full border border-border bg-surface  text-accent text-sm tracking-widest w-fit mb-6">
            ABOUT ME
          </p>
          <h2 className="text-4xl md:text-5xl font-bold mb-8">
            Behind the <span className="text-accent">screens</span>
          </h2>
          <div className="space-y-6 text-muted text-base md:text-lg leading-relaxed bg-surface  border border-border rounded-3xl p-8">
            <p>
        ...
        <div className="flex-1 w-full max-w-md lg:max-w-none">
          <div className="rounded-3xl border border-border bg-surface  overflow-hidden shadow-lg  hover:border-border hover:-translate-y-2 transition-all duration-500 relative group">
